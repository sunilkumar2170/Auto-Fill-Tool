  ...
  return (
    <section className="lg:flex lg:h-[825px] lg:justify-center dark:bg-gray-950 dark:text-white">
      ...
      <div className="mx-auto max-w-xl pt-8 text-center lg:mx-0 lg:grow lg:pt-32 lg:text-left">
        ...
        <p className="mt-3 text-lg text-gray-900 dark:text-gray-200 lg:mt-5 lg:text-xl">
        ...
        <p className="ml-6 mt-3 text-sm text-gray-600 dark:text-gray-300">
          No sign up required
        </p>
        ...
        <p className="mt-3 text-sm text-gray-600 dark:text-gray-300 lg:mt-36">
          ...
          <Link
            href="/resume-parser"
            className="underline underline-offset-2 dark:text-blue-300"
          >
            resume parser
          </Link>
        </p>
